<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, model.Classroom, model.Teacher, model.Account"%>
...
<title>Lớp giảng dạy — QLSV</title>
<link
...
<body>
	<div class="app-shell">
		...
		<div class="app-card">
			<h3 class="mb-3">
				<i class="fas fa-school me-2"></i>Lớp giảng dạy
			</h3>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-end"><a
								...
								href="<%=request.getContextPath()%>/teacher/classrooms/detail?id=<%=c.getId()%>">
									Xem sinh viên </a></td>
						</tr>
						<%
						}
						...
						<tr>
							<td colspan="6" class="text-center"
								...
								class="fas fa-inbox me-2"></i>Chưa có lớp giảng dạy nào</td>
						</tr>
						<%
}
%>
